...
-- Volcando estructura de base de datos para db_votaciones
CREATE DATABASE IF NOT EXISTS `db_votaciones` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `db_votaciones`;

-- Volcando estructura para tabla db_votaciones.candidatos
...
-- Volcando datos para la tabla db_votaciones.candidatos: ~2 rows (aproximadamente)
...
-- Volcando estructura para tabla db_votaciones.communes
...
-- Volcando datos para la tabla db_votaciones.communes: ~346 rows (aproximadamente)
...
-- Volcando estructura para tabla db_votaciones.regions
CREATE TABLE IF NOT EXISTS `regions` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `ordinal_symbol` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `order` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla db_votaciones.regions: ~16 rows (aproximadamente)
DELETE FROM `regions`;
...
-- Volcando estructura para tabla db_votaciones.votaciones
CREATE TABLE IF NOT EXISTS `votaciones` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_votaciones_regions1_idx` (`region_id`),
  KEY `fk_votaciones_communes1_idx` (`commun_id`),
  KEY `fk_votaciones_candidatos1_idx` (`candidato_id`),
  KEY `rut1_idx` (`rut`),
  CONSTRAINT `fk_votaciones_candidatos1` FOREIGN KEY (`candidato_id`) REFERENCES `candidatos` (`id`),
  CONSTRAINT `fk_votaciones_communes1` FOREIGN KEY (`commun_id`) REFERENCES `communes` (`id`),
  CONSTRAINT `fk_votaciones_regions1` FOREIGN KEY (`region_id`) REFERENCES `regions` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla db_votaciones.votaciones: ~0 rows (aproximadamente)
